import { c as create_ssr_component, a as compute_rest_props, v as validate_component, b as add_attribute, d as spread, e as escape_attribute_value, f as escape_object, g as getContext, i as is_void, s as setContext, h as subscribe } from "../../chunks/index2.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $activeNavLi, $$unsubscribe_activeNavLi;
  const activeNavLi = writable(null);
  $$unsubscribe_activeNavLi = subscribe(activeNavLi, (value) => $activeNavLi = value);
  $$unsubscribe_activeNavLi();
  return `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: ({ hidden, toggle }) => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `<span class="${"whitespace-nowrap text-xl font-semibold dark:text-white"}">Ben Drummond
		</span>`;
        }
      })}
